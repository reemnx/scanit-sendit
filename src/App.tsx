...
function App() {
  ...
  return (
    <div className='flex items-center bg-gray-100 w-screen h-screen'>
        <nav className={`${isNavMini ? 'basis-[80px]' : 'basis-[240px]'} transition-all duration-150 ease-in h-full border-r border-gray-300 bg-white flex flex-col items-center hidden`}>
